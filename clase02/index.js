...
function requestListener(req, res) { // callback: función (en este caso de 2 variables: request, response) que va a recibir la creación del servidor, que contiene la respuesta
    /* res.end ("Hola mundo!") */
